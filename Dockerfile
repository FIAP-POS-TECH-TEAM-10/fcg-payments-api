...
WORKDIR /src/app/src
RUN dotnet restore Fiap.FCGames.Payments.Api/Fiap.FCGames.Payments.Api.csproj

RUN dotnet publish Fiap.FCGames.Payments.Api/Fiap.FCGames.Payments.Api.csproj \
    -c Release \
    -o /app/publish \
    --no-restore
